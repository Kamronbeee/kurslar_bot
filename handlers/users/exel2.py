...
from keyboards.default.exel2 import menuexel2
...
async def show_menu(message: Message):
    await message.answer('Mavzulardan birini tanlang', reply_markup= menuexel2)
    await Course.exel2.set()

@dp.message_handler( text ='1-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='2-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='3-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='4-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='5-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='6-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='7-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='8-dars💻', state=Course.exel2)
...
@dp.message_handler( text ='9-dars💻', state=Course.exel2)
async def send_lesson_8(message: Message, state:FSMContext):
    await message.answer('9-dars💻:https://youtu.be/dz8EOmRP3G4?list=PLBsQ7kvE-3UhPlGTsc6EB9BLUrCa4I6MN')
9
@dp.message_handler( text ='Kompyuter savodxoligi kursiga qaytish👈', state=Course.exel2)
